...
namespace Recube.Core.Block
{
    public class ParsedProperty
    {
        ...
        public readonly Dictionary<int, object> Conditions;
        public readonly string PropertyName;
        public readonly FieldInfo Field;

        private ParsedProperty(string propertyName, Dictionary<int, object> conditions, FieldInfo field)
        {
        ...
        public static ParsedProperty Parse(Type t)
        {
            ...
            var conditions = new Dictionary<int, object>();
            ...
            return new ParsedProperty(nameAttr.PropertyKey, conditions, field[0]);
        }
    }
}